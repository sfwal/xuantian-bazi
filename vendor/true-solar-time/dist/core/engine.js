...
exports.calculateSolarCore = calculateSolarCore;
function calculateSolarCore(input) {
    const { civilYear, civilMonth, civilDay, civilHour, civilMinute, longitude, standardOffsetMinutes, dstOffsetMinutes, eotEngine } = input;
